echo -e "OG BAT_3_utr_gc BAT_5_utr_gc BRO_3_utr_gc BRO_5_utr_gc BGM_3_utr_gc BGM_5_utr_gc" > utr.reformat.tab
while read line;
do
...
echo -e "$og $BAT_thre $BAT_five $BRO_thre $BRO_five $BGM_thre $BGM_five" >> utr.reformat.tab
